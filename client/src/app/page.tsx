                ...
                <div className="flex flex-col lg:flex-row items-center gap-12">
                  ...
                  <div className="flex-1 text-center lg:text-left">
                    ...
                    >
                      ...
                      card that optimizes every purchase, giving you unmatched
                      value effortlessly.
                    </p>
                ...
                {[
                  {
                    ...
                    description:
                      "Secure login/signup pages with Clerk integration.",
                  },
                  {
                    icon: (
                      <svg
                    ...
                    description:
                      "Quick view of time credits, recent transactions, and notifications",
                  },
                  {
                    icon: "📝",
                    title: "Service Management",
                    description:
                      "Pages to offer and request services with form validations.",
                  },
                  {
                    icon: "⚡",
                    title: "Activity Feed",
                    description:
                      "Displays recent activities and transactions in a user-friendly layout..",
                  },
                  {
                    icon: "👥",
                    title: "Real-Time Notifications",
                    description:
                      "Live updates for messages and service status changes.",
                  },
                  {
                    icon: "🔒",
                    title: "Advanced Security",
                    description:
                      "Leading-edge security solutions for your data.",
                  },
                ].map((feature, index) => (
                  <motion.div
                    key={index}
                ...
                <div className="lg:w-1/2 space-y-6">
                  ...
                  <div className="space-y-4">
                    <FeatureCard
                      ...
                      description=" Transform your time into credits to exchange skills without money."
                      delay={0.1}
                    />
                    ...
                    <FeatureCard
                      ...
                      title="Trusted Skill Sharing"
                      description="Build a community through verified profiles and transparent feedback."
                      delay={0.2}
                    />
                    ...
                    <FeatureCard
                      ...
                      description="Enjoy a responsive, real-time platform that makes exchanging services effortless."
                      delay={0.3}
                    />
                  </div>
                </div>
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-[#666666] leading-relaxed">
                      Monitor result performance with real time insights. Track
                      your business metrics and make data-driven decisions.
                    </p>
            ...
            >
              <div className="flex flex-col lg:flex-row gap-16">
                ...
                >
                  ...
                  >
                    Unlock operational excellence and innovation with our
            ...
            <div className="py-24 bg-gradient-to-b from-white/50 to-white/30">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                  ...
                  <p className="text-[#666666] text-lg max-w-2xl mx-auto">
                    Find the right plan for your needs, with flexible choices
              ...
              <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                ...
                >
                  ...
                  <div className="text-center relative z-10">
                    ...
                    >
                      Sign up today and see the difference Active can make for
                      your business.
                    </motion.p>
